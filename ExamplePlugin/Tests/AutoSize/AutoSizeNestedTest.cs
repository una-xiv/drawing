...
public class AutoSizeNestedTest : DrawingTest
{
    private Node? _node;
    private int   _width  = 1260;
    private int   _height = 480;
    
    /// <inheritdoc/>
    public override string Name => "Deeply nested";
    ...
    {
        ImGui.TextWrapped("Tests deeply nested auto-sizing.");
